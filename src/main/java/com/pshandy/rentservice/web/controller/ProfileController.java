...
public class ProfileController {
    ...
    public ModelAndView changeUserAccount(@ModelAttribute("user") @Valid final UserDto userDto,
        ...
        if (result.hasErrors()) {
            return new ModelAndView("profile", result.getModel());
        }
        ...
        try {
            ...
            ModelAndView mav = new ModelAndView("profile", "user", userDto);
        ...
        return new ModelAndView("profile", "message", "Данные обновлены.");
